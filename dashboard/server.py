"""
dashboard/server.py — CyberVishuCodex Local HTTP Dashboard
    ...
    if sys.platform == "win32":
        ...
        try:
            ...
            if int(ret) > 32:
                ...
                print("[Dashboard] Phone connections may fail until CyberVishuCodex is run as Administrator.")
...
<p>Press <strong style="color:#dde3ed">Remote Control</strong> in CyberVishuCodex to get a new QR code.</p>
</div></body></html>""")
...
<p>Connecting to CyberVishuCodex…</p>
</body></html>""")
    ...
    async def serve(self) -> None:
        ...
        print("[Dashboard] Press 'Remote Control' in CyberVishuCodex UI to get the QR code.")
        await uvicorn.Server(cfg).serve()
