...
def _load_system_prompt() -> str:
    try:
        ...
        return (
            "You are CyberVishuCodex, an advanced AI assistant. "
...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "CyberVishuCodex checks these topics once a day and alerts the user when there is a new development. "
...
class JarvisLive:
    ...
    def __init__(self, ui: JarvisUI):
        self.ui             = ui
        self._asst_name     = "CyberVishuCodex"   # updated each session from config
        self.session              = None
    ...
    def _build_config(self) -> types.LiveConnectConfig:
        ...
        try:
            ...
            self._asst_name = (_cfg.get("assistant_name") or "CyberVishuCodex").strip()
            _user_name = (_cfg.get("user_name") or "").strip()
        except Exception:
            self._asst_name = "CyberVishuCodex"
            _user_name = ""
        ...
        while True:
            try:
                ...
                async with (
                    ...
                    self.ui.set_state("LISTENING")
                    self.ui.write_log("SYS: CyberVishuCodex online.")
